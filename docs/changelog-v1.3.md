...
- 完成新版架构文档升级：`architecture-v1.5.md`
- 新版架构进一步统一为更接近热门培训考试系统的菜单命名，一级二级菜单尽量采用四字风格，且不再出现两字菜单。
...
- 先依据 `architecture-v1.5.md` 统一前端页面、组件、路由和后端模块的落位。
...
6. 架构基线：`docs/architecture-v1.5.md`。
