...
- 完成 UI 设计规范升级：`design-system-v1.2.md`
- 完成新版架构文档升级：`architecture-v1.7.md`
- 已统一组件库口径为 `Element Plus + Tailwind CSS`，并同步到 UI 规范、架构文档与用户基线约束。
...
- 先依据 `architecture-v1.7.md` 统一前端页面、组件、路由和后端模块的落位。
...
6. 架构基线：`docs/architecture-v1.7.md`。
