...
- 完成新版架构文档升级：`architecture-v1.6.md`
- 新版架构补齐了第 4 章的角色拆分说明，明确了平台管理员、教师、评卷老师、学生各自拥有的菜单模块与页面落位。
...
- 先依据 `architecture-v1.6.md` 统一前端页面、组件、路由和后端模块的落位。
...
6. 架构基线：`docs/architecture-v1.6.md`。
